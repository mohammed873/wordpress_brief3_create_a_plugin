 ...
 * Version:           1.0.0
 * Author:            mohammed
 * Author URI:        https://medmestery.xzy
 * License:           GPL-2.0+
...
function deactivate_my_plugin() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-my_plugin-deactivator.php';
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-my_plugin.php';
